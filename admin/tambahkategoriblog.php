      ...
      <form class="form-horizontal" method="POST" action="konfirmasikategoriblog.php">
        <div class="card-body">
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              <input type="text" class="form-control" name="kategoriblog" value="">
            </div>
          </div>
        </div>
        <!-- /.card-body -->
        <div class="card-footer">
          <div class="col-sm-10">
            <button type="submit" class="btn btn-info float-right" name="tambahkategoriblog"><i class="fas fa-plus"></i> Tambah</button>
          </div>  
        </div>
        <!-- /.card-footer -->
      </form>
