  ...
  <div class="content-wrapper">
    ...
    <section class="content">
            <div class="card">
                ...
                <table class="table table-bordered">
                  ...
                  if (!empty($data)) {
                    ...
                    <tr>
                      ...
                      <td><?= $data[$i][1] ?></td>
                      <td align="center">
                        <a href="edittag.php?id=<?= $data[$i][0] ?>" class="btn btn-xs btn-info"><i class="fas fa-edit"></i> Edit</a>
              ...
              <a class='page-link'
              href='tag.php?katakunci=$katakunci_kategori&halaman=1'>First</a></li>";
              echo "<li class='page-item'><a class='page-link'
              href='tag.php?katakunci=$katakunci_kategori&halaman=$sebelum'>
              «</a></li>";
                      }
                      for ($i=1; $i<=$jum_halaman; $i++) {
                          if ($i!=$halaman) {
                              echo "<li class='page-item'><a class='page-link'
              href='tag.php?katakunci=$katakunci_kategori&halaman=$i'>$i</a></li>";
                          } else {
                              echo "<li class='page-item'>
              <a class='page-link'>$i</a></li>";
                      ...
                      if ($halaman!=$jum_halaman) {
                          echo "<li class='page-item'>
              <a class='page-link'
              href='tag.php?katakunci=$katakunci_kategori&halaman=$setelah'>»</a></li>";
                          echo "<li class='page-item'><a class='page-link'
              href='tag.php?katakunci=$katakunci_kategori&halaman=$jum_halaman'>
              Last</a></li>";
                      }
                  } else {
                      if ($halaman!=1) {
              ...
              href='tag.php?halaman=1'>First</a></li>";
                          echo "<li class='page-item'><a class='page-link'
              href='tag.php?halaman=$sebelum'>«</a></li>";
                      }
                      for ($i=1; $i<=$jum_halaman; $i++) {
                          if ($i!=$halaman) {
                              echo "<li class='page-item'><a class='page-link'
              ...
              »</a></li>";
                          echo "<li class='page-item'><a class='page-link'
              href='tag.php?halaman=$jum_halaman'>Last</a></li>";
                      }
                  }
              }?>
              </ul>
...
swalWithBootstrapButtons.fire({
  ...
  if (result.isConfirmed) {
    ...
    setTimeout(() => {
      location.replace("hapustag.php?id="+id);
    }, 700);
  } else if (
