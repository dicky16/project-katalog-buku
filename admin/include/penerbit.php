            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a href="tambah-penerbit" class="btn btn-sm btn-info float-right">
              ...
              <form method="POST" action="set-session">
                    <div class="row">
                        <div class="col-md-4 bottom-10">
                          <input type="hidden" name="tujuan" value="penerbit">
                ...
                <table class="table table-bordered">
                  ...
                  if (!empty($data)) {
                    ...
                    <tr>
                      ...
                      <td><?= $data[$i][2] ?></td>
                      <td align="center">
                        <a href="edit-penerbit-id-<?= $data[$i][0] ?>" class="btn btn-xs btn-info"><i class="fas fa-edit"></i> Edit</a>
                        <a href="#" class="btn btn-xs btn-warning hapus-penerbit" data-id="<?= $data[$i][0] ?>"><i class="fas fa-trash"></i> Hapus</a>
                      </td>
                    </tr>
                    <?php
                    $no++;
              ...
              <a class='page-link'
              href='penerbit-halaman-1'>First</a></li>";
                          echo "<li class='page-item'><a class='page-link'
              href='penerbit-halaman-$sebelum'>
              «</a></li>";
                      }
                      for ($i=1; $i<=$jum_halaman; $i++) {
                          if ($i!=$halaman) {
                              echo "<li class='page-item'><a class='page-link'
              href='penerbit-halaman-$i'>$i</a></li>";
                          } else {
                              echo "<li class='page-item'>
              <a class='page-link'>$i</a></li>";
                      ...
                      if ($halaman!=$jum_halaman) {
                          echo "<li class='page-item'>
              <a class='page-link'
              href='penerbit-halaman-$setelah'>»</a></li>";
                          echo "<li class='page-item'><a class='page-link'
              href='penerbit-halaman-$jum_halaman'>
              Last</a></li>";
                      }
                  } else {
                      if ($halaman!=1) {
              ...
              href='penerbit-halaman-1'>First</a></li>";
                          echo "<li class='page-item'><a class='page-link'
              href='penerbit-halaman-$sebelum'>«</a></li>";
                      }
                      for ($i=1; $i<=$jum_halaman; $i++) {
                          if ($i!=$halaman) {
                              echo "<li class='page-item'><a class='page-link'
              href='penerbit-halaman-$i'>$i</a></li>";
                      ...
                      if ($halaman!=$jum_halaman) {
                          echo "<li class='page-item'><a class='page-link'
              href='penerbit-halaman-$setelah'>
              »</a></li>";
                          echo "<li class='page-item'><a class='page-link'
              href='penerbit-halaman-$jum_halaman'>Last</a></li>";
                      }
                  }
              }?>
                </ul>
